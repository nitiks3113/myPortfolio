  ...
  return (
    <footer className="relative overflow-hidden bg-black">
      ...
      transition={{duration:0.8}}>
        ...
        <p className="text-gray-300 italic max-w-xl">Code with logic. Build with passion. Deliver with impact.</p>
        <p className="text-xs text-gray-400">&copy; {new Date().getFullYear()} Nitik Kumar Sahay. All rights reserved.</p>
      </motion.div>
    </footer>
  )
}